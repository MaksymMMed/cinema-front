        ...
        {tickets.map((Invoice) => (
            ...
            <div style={{ display: 'flex'}}>
                <Link to={`/film/${Invoice.tickets[0].movie.id}`}>
                    <img
                        src={Invoice.tickets[0].movie.imageUrl}
                        alt={Invoice.tickets[0].movie.name}
                    />
                </Link>
                <div style={{ marginLeft: '40px' }}>
                    <h3>{Invoice.id}</h3>
                    <p style={{ fontSize: '20px' }}>{Invoice.tickets[0].movie.name}</p>
                    <div style={{ display: 'flex' }}>
                        <div>
                            <p>date:</p>
                            <p>
                    ...
                    <div className='all-tickets'>
                        <TicketsDropdownList tickets={Invoice.tickets} price={Invoice.amount} isPaid={Invoice.isPaid}/>
                    </div>
                </div>
            </div>
        </div>
